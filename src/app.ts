...
// Configure CORS
app.use(cors({
  origin: ["http://workspace-detail.s3-website.eu-north-1.amazonaws.com","http://localhost:5173", "http://localhost:5174", "http://localhost:5175", "http://127.0.0.1:5173", "http://127.0.0.1:5174", "http://127.0.0.1:5175"],
  credentials: true,
